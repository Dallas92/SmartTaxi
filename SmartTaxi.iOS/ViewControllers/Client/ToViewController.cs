	...
	public partial class ToViewController : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			mapView.TappedMarker = (map, marker) => {
				AppDelegate.Order.ToAddress = _txtView.Text;
				AppDelegate.Order.ToLocation = marker.Position.Latitude +", "+marker.Position.Longitude;
				var vController = (AppDelegate.Storyboard.InstantiateViewController ("WhenViewController") as UIViewController);
		...
		public override void ViewWillAppear (bool animated)
		{
			...
			_txtView.Text = !string.IsNullOrEmpty(AppDelegate.Order.ToAddress)?AppDelegate.Order.ToAddress:"КУДА";
			_txtView.Font = UIFont.FromName (AppDelegate.FontRobotoCondensedLight,!string.IsNullOrEmpty(AppDelegate.Order.ToAddress)?16f:25f);
			...
			_txtView.Delegate = new TextViewDelegate ("КУДА");
		}
